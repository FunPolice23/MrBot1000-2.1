...
- **Naming**: All references to "Marcus Rivera"/"Alex Vega" replaced with "Edward Hurst"/"Jacob Stanley" (or custom names from env vars) across dialogue_tab.py, persona_naming.py, dual_brain_control.py.
